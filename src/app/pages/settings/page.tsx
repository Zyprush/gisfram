...
import { IconDownload, IconPassword, IconSettings } from "@tabler/icons-react";
      ...
      <div className="flex h-screen overflow-auto">
        <div className="p-2 md:p-8 border border-neutral-200  dark:border-neutral-700 bg-[#f5f5f5] dark:bg-neutral-900 flex flex-col items-start justify-start gap-5 w-full h-full ">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <a
              href="/user-guide.docx" // Path to the file in the public folder
              download="User-Guide.docx" // Suggested filename
