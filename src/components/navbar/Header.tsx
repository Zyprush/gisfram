...
const Header = () => {
  ...
  return (
    <span className="w-full h-14 bg-gradient-to-r from-gray-200 to-gray-100 dark:from-gray-900 dark:to-gray-800 custom-shadow justify-between px-5 items-center border-b border-zinc-300 dark:border-zinc-700 hidden md:flex">
    <button
        onClick={toggleTheme}
